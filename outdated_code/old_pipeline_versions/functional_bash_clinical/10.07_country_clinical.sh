...
## script extracts clinical flu samples from a merged FASTA, grouping them based on the Month_Year column from their respective metadata
## run after using R to create the metadata file with Month_Year column
...
## load in files
METADATA="/gpfs1/projects/Tisza_Lab/crm_flu_mutatome/clinical_flu_mutatome/country/metadata/${VARIANT}_country_my.tsv"
FASTA="/gpfs1/projects/Tisza_Lab/crm_flu_mutatome/clinical_flu_mutatome/country/fasta/${VARIANT}_USA.fasta"
REF_FASTA="/gpfs1/projects/Tisza_Lab/crm_flu_mutatome/${VARIANT}_align/reference/FASTA/${VARIANT}_reference.fasta"

## set output directory
OUTPUT_DIR="/gpfs1/projects/Tisza_Lab/crm_flu_mutatome/clinical_flu_mutatome/country/${VARIANT}/alignment_files"
